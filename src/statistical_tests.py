#!/usr/bin/env python3
"""
statistical_tests.py — Paired Statistical Significance Testing
===============================================================
Corresponds to: Section 6.10 of the paper.

Runs a paired t-test comparing NAFT vs TFT payoffs at a fixed
high-noise level (ε = 0.15). Reports mean payoffs, mean difference,
